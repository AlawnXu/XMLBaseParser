...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnGenericXMLParser).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void doRemoteXMLParser() {
        String url = "https://github.com/AlawnXu/XMLBaseParser/blob/master/test.xml";
        OkHttpUtils
                .get()
                .url(url)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        beginParser(response);
                    }
                });
    }

    private void beginParser(String response) {
        if (!TextUtils.isEmpty(response)) {
            ...
            if (canlarModelArrayList != null && !canlarModelArrayList.isEmpty()) {
                for (CanlarModel model : canlarModelArrayList) {
                    Log.i(MainActivity.class.getSimpleName().concat("xml data:"), model.toString());
                }
            }
        }
    }
